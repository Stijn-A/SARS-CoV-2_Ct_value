...
gam_ps_vacc <- readRDS("~/01_projects/02_sars_cov_2/ct_values_evt/cache/gam_ps_vacc.rds")
...
boxplot_fct_previous_infection %>%
  write_rds(file = "output/boxplot_fct_previous_infection.rds")
