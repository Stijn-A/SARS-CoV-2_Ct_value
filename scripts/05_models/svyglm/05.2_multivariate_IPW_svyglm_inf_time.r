...
model_prev_inf_time %>% write_rds("cache/model_prev_inf_time_ps.rds")
...
models_targets[[1]] %>% 
  ...
  saveRDS("cache/mod_outcome_inf_time.rds")

boxplot_prev_inf_time %>%
  write_rds(file = "output/boxplot_prev_inf_time.rds")

plot_outcomes_fct_prev_inf_time %>% 
  write_rds(file = "output/plot_outcomes_fct_prev_inf_time_N.rds")
